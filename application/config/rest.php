...
$config['auth_override_class_method']['family']['*'] 					= 'none';
$config['auth_override_class_method']['person']['*'] 					= 'none';
...
|
*/
$config['rest_valid_logins'] = array('usr_admin' => '@XRY+5WW=2=FUYQE');
...
|
*/
$config['rest_keys_table'] = 'ms_keys';
