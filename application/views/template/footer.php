...
<script src="<?php echo base_url('static')?>/dist/js/pages/dashboard2.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo base_url('static')?>/dist/js/demo.js"></script>

<!-- Validation Engine -->
<script src="<?php echo base_url('static')?>plugins/validation_engine/js/jquery.validationEngine-en.js" type="text/javascript" charset="utf-8"></script>
