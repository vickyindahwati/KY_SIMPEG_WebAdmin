...
<div class="box-body">
    ...
    <br>
    <table id="dt-table-riwayat-pendidikan-umum" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>No.</th>
                <th>Tingkat</th>
...
<script src="<?php echo base_url('static');?>/custom/riwayatpendidikanumum.js"></script>