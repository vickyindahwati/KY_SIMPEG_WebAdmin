  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">FORM EVOUCHER MANAGEMENT</h4>
      </div>
          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group">
                <label for="input1" class="col-sm-3 control-label">Merchant</label>
                <div class="col-sm-9">
              ...
              <div class="form-group" id="container-support-name">
                ...
                <div class="col-sm-9">
                  <input type="text" name="x_product_name" id="x_product_name" class="form-control">
                </div>
              </div>
              <div class="form-group" id="container-support-name">
                <label for="input1" class="col-sm-3 control-label">Voucher Value</label>
                <div class="col-sm-9">
                  <input type="text" name="x_voucher" id="x_voucher" class="form-control">
                </div>
              </div>
              <div class="form-group" id="container-support-name">
...
function loadList( method, param ){
  ...
  $.ajax({
    ...
    type        : method,
    url         : '<?php echo base_url();?>index.php/evoucher/getEVoucherData',
    data        : param,
...
$(document).ready(function(){
  ...
  var upload_setting = {
      url: "<?php echo base_url();?>index.php/evoucher/uploadFile",
      dragDrop:true,
      fileName: "x_file",
      ...
      deleteCallback: function(data,pd)
    {
        ...
        {
            $.post("<?php echo base_url();?>index.php/evoucher/cancelUploadFile",{op:"delete",name:data[i]},
        ...
        onValidationComplete: function(form,status) {
            if (status === true) {
              ...
              $.ajax({
                ...
                type        : 'POST',
                url         : '<?php echo base_url()?>index.php/evoucher/save',
  ...
  $('form#form-conf-delete').submit(function(){
      ...
      $.ajax({
          ...
          type        : 'POST',
          url         : '<?php echo base_url();?>index.php/evoucher/delete',
