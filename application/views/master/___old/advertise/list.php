  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">FORM ADVERTISE MANAGEMENT</h4>
      </div>
          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="form-control" id="x_company" name="x_company"> 
                    <option value="">-Please Select-</option>

                    <?php 
                      foreach( $rsCompany as $dtCompany ){
                    ?>
                        <option value="<?php echo $dtCompany->companyId ?>"><?php echo $dtCompany->companyName; ?></option>
                    <?php    
                      }
                    ?>
              ...
              <div class="form-group">
                <label for="input1" class="col-sm-3 control-label">Advertise Type</label>
                <div class="col-sm-9">
                  <select class="form-control" id="x_advertise_type" name="x_advertise_type"> 
                    <option value="">-Please Select-</option>
              ...
              <div class="form-group" id="container-advertise-rebate" style="display:none;">
                <label for="input1" class="col-sm-3 control-label">Adv. Rebate</label>
                <div class="col-sm-9">
                  <input type="text" name="x_advertise_rebate" id="x_advertise_rebate" class="form-control">
                </div>
              </div>
              <div class="form-group" id="container-advertise-balance" style="display:none;">
                <label for="input1" class="col-sm-3 control-label">Adv. Balance</label>
                <div class="col-sm-9">
                  <input type="text" name="x_advertise_balance" id="x_advertise_balance" class="form-control">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group" id="container-support-name">
                <label for="input1" class="col-sm-3 control-label">Sequence</label>
                <div class="col-sm-9">
                  <input type="text" name="x_sequence" id="x_sequence" class="form-control">
                </div>
              </div>
              <div class="form-group" id="container-support-name">
                <label for="input1" class="col-sm-3 control-label">Period</label>
                <div class="col-sm-9">
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right" id="x_period" name="x_period">
                  </div>
                </div>
              </div>
              <div class="form-group">
...
function loadList( method, param ){
  ...
  $.ajax({
    ...
    type        : method,
    url         : '<?php echo base_url();?>index.php/advertise/getAdvertiseData',
    data        : param,
...
$(document).ready(function(){
        ...
        onValidationComplete: function(form,status) {
            if (status === true) {
              ...
              $.ajax({
                ...
                type        : 'POST',
                url         : '<?php echo base_url()?>index.php/advertise/save',
  ...
  var upload_setting = {
      url: "<?php echo base_url();?>index.php/advertise/uploadFile",
      dragDrop:true,
      fileName: "x_file",
      ...
      deleteCallback: function(data,pd)
    {
        ...
        {
            $.post("<?php echo base_url();?>index.php/advertise/cancelUploadFile",{op:"delete",name:data[i]},
  ...
  $('form#form-conf-delete').submit(function(){
      ...
      $.ajax({
          ...
          type        : 'POST',
          url         : '<?php echo base_url();?>index.php/advertise/delete',
  ...
  $('#x_advertise_type').change(function(){
    if( $(this).val() == 2 ){
