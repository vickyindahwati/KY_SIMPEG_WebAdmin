  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">FORM OPENING IMAGE</h4>
      </div>
          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group">
                <label for="input1" class="col-sm-3 control-label">Image</label>
                <div class="col-sm-9">
...
<section class="content-header">
  <h1>
    <?php echo $title;?>
    <small>Data Opening Image</small>
  </h1>
</section>
...
function loadList( method, param ){
  ...
  $.ajax({
    ...
    type        : method,
    url         : '<?php echo base_url();?>index.php/openingimage/getOpeningImageData',
    data        : param,
...
$(document).ready(function(){
        ...
        onValidationComplete: function(form,status) {
            if (status === true) {
              ...
              $.ajax({
                ...
                type        : 'POST',
                url         : '<?php echo base_url()?>index.php/openingimage/save',
  ...
  var upload_setting = {
      url: "<?php echo base_url();?>index.php/openingimage/uploadFile",
      dragDrop:true,
      fileName: "x_file",
      ...
      deleteCallback: function(data,pd)
    {
        ...
        {
            $.post("<?php echo base_url();?>index.php/openingimage/cancelUploadFile",{op:"delete",name:data[i]},
  ...
  $('form#form-conf-delete').submit(function(){
      ...
      $.ajax({
          ...
          type        : 'POST',
          url         : '<?php echo base_url();?>index.php/openingimage/delete',
