...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="modal-userunor-header-form" style="overflow-y: scroll;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="gridSystemModalLabel">FORM ID PETA JABATAN</h4>                
            </div>
            <form id="frm-userunor-header" name="frm-userunor-header" class="form-horizontal">
                <input type="hidden" name="x_id_userunorheader" id="x_id_userunorheader" value="">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="input1" class="col-sm-3 control-label">Kode</label>
                                <div class="col-sm-9">
                                    <input type="text" name="x_code" id="x_code" class="form-control">
                                </div>          
                            </div>
                            <div class="form-group">
...
<div class="box-body">
    <p>
        <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#modal-userunor-header-form" id="btn-add-news"><i class="fa fa-plus"></i>&nbsp;Tambah Baru</button>
    </p>
    <br>
